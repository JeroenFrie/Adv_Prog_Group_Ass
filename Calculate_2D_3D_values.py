...
data = CSV_Loader("tested_molecules_v3.csv")
data = data.drop(labels=909,axis=0)
num_conformers = 20
...
for index, row in data.iterrows():  #This line is changed to skip row 909 which doesnt exist
